...
there is no physical isolation for parallel builders (`orchestrators/skills/dae/worktree-modes.md:13-15`
for the mode's definition; `orchestrators/skills/dae/build.md:27` for the single-lane
...
**Source.** `orchestrators/skills/dae/worktree-modes.md:13-15`, `orchestrators/skills/dae/build.md:27`.
